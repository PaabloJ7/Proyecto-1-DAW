...
try {
	...
	{
		if (e.getSQLState().equals("23000")) { // Error de duplicado de clave
			request.setAttribute("errorMsg", "El nombre de usuario ya está en uso. Por favor, elige otro nombre de usuario.");
		} else {
			request.setAttribute("errorMsg", "Ha ocurrido un error durante el registro. Por favor, inténtalo de nuevo.");
		}
	}
%>  
<!DOCTYPE html>
